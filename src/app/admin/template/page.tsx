...
■保存方法について
【iPhone・Androidの方】
写真をタップして拡大後、画像を長押ししてください。表示されるメニューから「写真に追加」「画像を保存」「画像をダウンロード」など、保存に関する項目（ご利用の機種・ブラウザによって表記が異なります）を選択すると、1枚ずつ端末に直接保存できます。

【PCの方】
ページ最下部の『一括保存（ZIP）』ボタンから、すべての写真をまとめて保存できます。

※保存期限を過ぎると写真の閲覧・保存ができなくなりますので、お早めの保存をおすすめいたします。
